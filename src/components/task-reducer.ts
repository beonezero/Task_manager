...
const changeTaskStatusAC = (task: TaskType) => ({type: "TASK/UPDATE-TASK", task}) as const
...
export const updateTaskTC = (todolistId: string, taskId: string, model: ModelDomainType) => (dispatch: Dispatch, getState: () => AppRootStateType) => {
